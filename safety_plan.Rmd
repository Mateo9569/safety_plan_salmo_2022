...
A kml file containing the site at the end of Carney Mill Road in Salmo where we are going to carry out a snorkel survey can be downloaded [here](https://github.com/Mateo9569/safety_plan_salmo_2022/raw/main/mapping/Carney.kmz). Another potential survey site in Salmo can be seen on this orthomosaic map that can be accessed [here](https://www.mapsmadeeasy.com/maps/public/d67c01a499be4c30b7d1c74b72a4101b).
